...
describe('CalculadoraService', () => {
  ...
  it('deve garantir que 1/4 = 0.25', inject([CalculadoraService], (service: CalculadoraService) => {
    let divisao = service.calcular(1,4,CalculadoraService.DIVIZAO)
    expect(divisao).toEqual(0.25);
  }));

  it('deve retornar 0 para operaçao invalida', inject([CalculadoraService], (service: CalculadoraService) => {
